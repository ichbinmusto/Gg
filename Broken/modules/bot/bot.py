...
from Broken import CMD_HELP, app
from Broken.helper.data import Data
from Broken.helper.inline import cb_wrapper, paginate_help
from Broken import ids as users
...
async def on_plug_in_cb(_, callback_query: CallbackQuery):
    ...
    this_command += "© @BroknxSupport ✘ @BrokenxNetwork"
    bttn = [
