...
from Broken import START_TIME
from Broken import SUDO_USER
from Broken.helper.PyroHelpers import ReplyCheck
from Broken.modules.help import add_command_help
from Broken.modules.bot.inline import get_readable_time

alive_logo = ALIVE_PIC or "https://telegra.ph/file/4513f188be254572697e3.jpg"
...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        ...
        f"├• **sᴜᴘᴘᴏʀᴛ**: [ᴄʜᴀᴛ](t.me/+2tyYGwWgsb4zMWY1)\n"
        f"├• **ᴄʜᴀɴɴᴇʟ**: [ᴛᴀᴘ](t.me/BrokenxNetwork)\n"
        f"└• **sᴏᴜʀᴄᴇ**: [ʀᴇᴘᴏ](https://GitHub.com/MRXBROKEN011/BROKENUSERBOT)"        
    )
...
async def repo(bot: Client, message: Message):
    ...
    await message.edit("Fetching Source Code......")
    await asyncio.sleep(2)
    await message.edit("Here is repo: \n\n\n https://github.com/MRXBROKEN011/BROKENUSERBOT \nFork & Give an ⭐")


@Client.on_message(filters.command("creator", ".") & filters.me)
async def creator(bot: Client, message: Message):
    await message.edit("https://gitHub.com/Mrxbroken011")
